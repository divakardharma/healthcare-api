...
class BillingController
{
    ...
    public function create(): array
    {
        ...
        $billingId = $this->billingService->createInvoice(
            (int)$patientId,
    ...
    {
        $invoice = $this->billingService->getInvoiceById(
            $billingId
        );
        return [
    ...
    // Update Invoice
    // ========================================
    public function update(int $billingId): array
    {
        $input = json_decode(
            file_get_contents('php://input'),
            true
    ...
    {
        $this->billingService->deleteInvoice($billingId);
        return [
    ...
    // ========================================
    public function updatePaymentStatus(int $billingId): array
    {
        $input = json_decode(
            file_get_contents('php://input'),
            true
    ...
    {
        $summary = $this->billingService->getPaymentSummary();
        return [
